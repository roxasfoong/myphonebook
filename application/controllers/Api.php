    ...
    public function update_contact_view(){
        ...
        if ($this->contact_model->load_database()) {
            ...
            if ($this->input->is_ajax_request()) 
            {
                ...
                $current_page = $this->input->input_stream('current_page');
                $sanitized_current_page = $this->security->xss_clean( $current_page);
                $user_id = $this->session->userdata('user_id');

                $result = $this->contact_model->get_all_contacts_with_offset($user_id,$sanitized_current_page);
                ...
                if ($result) {
                    ...
                    $response['new_current_page'] = $this->contact_model->compare_page_number($user_id,$sanitized_current_page);
